# coding=utf-8
# created by msg on 2019/11/23 10:28 上午
...
class QNetwork(tf.keras.Model):
    def __init__(self):
        super().__init__()
        self.dense1 = Dense(units=24, activation=tf.nn.relu)
        self.dense2 = Dense(units=24, activation=tf.nn.relu)
        self.dense3 = Dense(units=2)
